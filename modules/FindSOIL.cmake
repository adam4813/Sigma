...
FIND_PATH(SOIL_INCLUDE_DIR SOIL.h PATH_SUFFIXES include/SOIL include SOIL)
IF (APPLE)
	# For the case where SOIL is installed in a non-standard lib path such as /opt or /sw
	FIND_PATH(SOIL_INCLUDE_DIR_NO_SUFFIX SOIL/SOIL.h)
	INCLUDE_DIRECTORIES( "${SOIL_INCLUDE_DIR_NO_SUFFIX}")
ENDIF (APPLE)

IF (APPLE)
	# Prefer the Static lib.
	SET(SOIL_NAMES libSoil.a SOIL Soil soil)
ELSE (APPLE)
