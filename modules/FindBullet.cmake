...
FIND_PATH(BULLET_INCLUDE_DIR btBulletDynamicsCommon.h PATH_SUFFIXES bullet)

MESSAGE("Found: ${BULLET_INCLUDE_DIR}")
...
#SET(BULLET_SOFTBODY_LIBRARIES "${BULLET_SOFTBODY_LIBRARY}")
SET(BULLET_DYNAMICS_LIBRARIES "${BULLET_DYNAMICS_LIBRARY}")
SET(BULLET_COLLISION_LIBRARIES "${BULLET_COLLISION_LIBRARY}")
SET(BULLET_LINEARMATH_LIBRARIES "${BULLET_LINEARMATH_LIBRARY}")
