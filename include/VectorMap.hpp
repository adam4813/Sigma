...
namespace Sigma {
    template<class V>
    using aligned_vector_type = std::vector<V, AlignedVectorAllocator<V>>;
    ...
    public:
        ...
        */
         ...
         *
         * \return const aligned_vector_type<V>* the vector
         *
         */
        const aligned_vector_type<V>* getVector() { return &data_vector; }
    ...
    private:
        ...
        void Resize() {
            ...
            aligned_vector_type<V> v_copy(data_vector.size() << 1);
            v_copy = data_vector;
        ...
        aligned_vector_type<V> data_vector;
