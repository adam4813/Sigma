...
inline static void transform_n_sse2(size_t length, const Operation& op)
{
...
template<class Operation>
inline static void transform_n_sse2(size_t length, Sigma::BitArray<unsigned short>& bitmap, const Operation& op)
{
  size_t n = ROUND_DOWN(length, op.BLOCK_SIZE);
  // execute op on array elements block-wise
...
template<class Operation>
inline static void transform_n_scalar(size_t length, const Operation& op)
{
  size_t n;
...
template<class Operation>
inline static void transform_n_scalar(size_t length, const Sigma::BitArray<unsigned short>& bitmap, const Operation& op)
{
  size_t n;
  // execute the array elements one by one
  for(n = 0; n < length; n++) {
